...
;===============================================================================
;===============================================================================
; JOYSTICK has been moved up, left or right
;===============================================================================
@moveUp                                
;===============================================================================
; SPRITE FALLS DOWN IF < 22
; PLAYER_JUMP_POS = PLAYER_JUMP_POS + 1
; If PLAYER_JUMP_POS < 20 then goto @moveSpriteUp
; If PLAYER_JUMP_POS < 40 then goto @exitJumpState
;===============================================================================
@spriteFalls
        lda PLAYER_JUMP_POS             ; for PLAYER_JUMP_TABLE,x to read until
        cmp #10                         ; it finds a "0" value. 28 bytes
